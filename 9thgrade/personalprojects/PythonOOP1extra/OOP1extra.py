...
def managerPowers():
    ...
    if outputUsers.lower() == 'y':
        ...
        if endLoop.lower() == 'y':
            ...
            print('Shutting down...')
            with open('9thgrade/personalprojects/PythonOOP1extra/data.json', 'w') as data:
                data.write(json.dumps(userData, sort_keys = True, indent = 4))
            with open('9thgrade/personalprojects/PythonOOP1extra/encrypted.txt', 'w') as encrypted:
...
try:
    with open ('9thgrade/personalprojects/PythonOOP1extra/encrypted.txt', 'r') as file:
        data = file.read()
